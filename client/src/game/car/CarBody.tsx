...
import { cosmeticMaterial, neonMaterial, paintedTextureMaterial, useSpoilerGeometry } from './tuningParts';
  ...
  return (
    <>
      ...
      {spoiler && (
        <mesh
          geometry={spoiler}
          material={paint ?? cosmeticMaterial('paint', look.paint) ?? cosmeticMaterial('spoiler', look.spoiler)}
          castShadow
        />
      )}
      {neon && (
